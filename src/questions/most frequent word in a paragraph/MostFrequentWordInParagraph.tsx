...
const MostFrequentWordInParagraph = () => {
	const [activeTab, setActiveTab] = useState<string | null>('question')
	return (
		<Stack>
			<Group justify="space-between" gap="lg">
				<Title order={3}>Most Frequent Word In a Paragraph</Title>
				<Button
					component="a"
					href="https://devtools.tech/questions/s/how-to-find-the-most-frequent-word-in-a-paragraph-frontend-problem-solving-or-javascript---qid---vigN3iSuX6Vj6JSpzXvC"
					target="_blank"
				>
...
export default MostFrequentWordInParagraph
